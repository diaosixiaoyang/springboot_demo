...
public class HttpClientUtil {
    ...
    public static String callUrlGet(String url) throws IOException, HttpException {
        return HttpClientUtil.callUrlGet(url, "UTF-8");
    }

    public static String callUrlGet(String url, String charset) throws IOException, HttpException {
    ...
    public static String callUrlGetWithHeader(String url, Map<String, Object> paramsMap, Map<String, String> headers) throws IOException, HttpException {
    ...
    public static String callUrlPost(String url, Map<String, Object> paramsMap) throws IOException, HttpException {
        // 获取内容
    ...
    public static String callUrlPostForJson(String url, Map<String, Object> paramsMap) throws IOException, HttpException {
        // 获取内容
        HttpPost httpPost = new HttpPost(url);
    ...
    public static Map<String, Object> callUrlPostReturnMap(String url, Map<String, Object> paramsMap) throws IOException, HttpException {
    ...
    public static String callUrlPost(String url, List<NameValuePair> params) throws IOException, HttpException {
        // 获取内容
        HttpPost httpPost = new HttpPost(url);
        httpPost.setEntity(new UrlEncodedFormEntity(params, "UTF-8"));
