 ...
 */
@Service(version = "1.0.0", interfaceClass = DictionaryMService.class, timeout = 10000, cluster = "failfast")
public class DictionaryMServiceImpl implements DictionaryMService {
